    ...
    public static String generarXMLZipiadoBoleta(String iddocument, Connection conn) {
        ...
        try {
            ...
            if (items != null) {
                ...
                log.info("generarXMLZipiadoBoleta - Crear Hashcode y CodeBarPDF417");
//                LecturaXML.guardarHashYBarCodePDF417(items.getDocu_tipodocumento(), nrodoc, "DV", pathXMLFile, conn);
                ...
                //======================guardar PDF =======================
                resultado = GeneralFunctions.creaPdf(items, unidadEnvio, conn, "BoletaElectronica.jasper");
                ...
                if (items.getDocu_enviaws().equals("S")) {
                    ...
                    resultado = enviarZipASunat(nrodoc, unidadEnvio, items.getEmpr_nroruc() + "-03-" + items.getDocu_numero() + ".zip", conn, items.getEmpr_nroruc());
                } else {
                ...
                log.info("generarXMLZipiadoBoleta - Proceso creado correctamente  " + items.getEmpr_nroruc() + "-03-" + items.getDocu_numero());
