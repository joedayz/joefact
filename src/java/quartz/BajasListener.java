 ...
 */
@WebListener
public class BajasListener  extends QuartzInitializerListener {
    private static final Logger LOG = LoggerFactory.getLogger(BajasListener.class);
    ...
    public void contextInitialized(ServletContextEvent event) {
        ...
        try {
            ...
            JobDetail job = JobBuilder.newJob(BajasJob.class).build();
            Trigger trigger = TriggerBuilder.newTrigger().withIdentity("simple3").withSchedule(
